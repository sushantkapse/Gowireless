...
?>
	  ...
	  <h2>Plans List</h2>
	  <h3><a href="add-plan.php" class="btn" title="Add Plan"><i class="fa fa-plus"></i></a></h3>
...
?>
	<tr>
		...
		<td><?=$row[4]?></td>
		<td><?=$row[5]?></td>
		<td><a href="delete-plan.php?pid=<?=$row[0]?>" class="btn" onclick="return confirm('Delete plan?')" title="Delete"><i class="fa fa-trash-o"></i></a></td>
		<td><a href="edit-plan.php?pid=<?=$row[0]?>" class="btn" title="Edit"><i class="fa fa-edit"></i></a></td>
	</tr>
<?php
	}
?>	
