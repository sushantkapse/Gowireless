...
<?php
	$rs = mysqli_query($con, "SELECT `AUTO_INCREMENT` FROM  INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'isp' AND TABLE_NAME = 'Employee'");
	$row = mysqli_fetch_row($rs);
	$id = $row[0];
?>
	  
	  <form method="post" action="add-employee1.php">
	  <table>
	  <tr>
