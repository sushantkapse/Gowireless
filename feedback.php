...
<?php
	$rs = mysqli_query($con, "select * from feedback order by id");
?>
...
?>
	<tr>
		...
		<td><?=$row[4]?></td>
		<td><?=$row[5]?></td>
		<td><a href="delete-feedback.php?id=<?=$row[0]?>" class="btn" title="Delete" onclick="return confirm('Delete feedback?')"><i class="fa fa-trash-o"></i></a></td>
	</tr>
<?php
	}
?>	
