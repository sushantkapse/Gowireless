...
<?php
	$rs = mysqli_query($con, "SELECT `AUTO_INCREMENT` FROM  INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'isp' AND TABLE_NAME = 'question'");
	$row = mysqli_fetch_row($rs);
	$id = $row[0];
?>
	  
	  <form method="post" action="add-faq1.php">
	  <table>
	  <tr>
	  	<td colspan=2 align="center"><b>Add FAQ</b></td>
	  </tr>
	  <tr>
	  ...
	  <tr>
	  	<td><b>Answer:</b></td>
	  	<td><textarea name="answer" required rows="5" cols="50"></textarea></td>
	  </tr>
	  <tr>
