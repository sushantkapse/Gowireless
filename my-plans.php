...
<?php
	$cid = $_SESSION["cid"];
	$rs = mysqli_query($con, "select bill_id, bill_date, plan_name, cost, status from plans, bill where bill.plan_id = plans.plan_id and c_id=$cid order by bill_id");
?>
...
?>
	<tr>
		...
		<th><?=$row[3]?></th>
		<th><?=$row[4]?></th>
		<th><a href="view-bill.php?bid=<?=$row[0]?>" class="btn" title="View Bill"><i class="fa fa-eye"></a></th>
	</tr>
<?php
	}
?>	
